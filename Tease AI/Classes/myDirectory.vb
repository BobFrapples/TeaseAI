...
#Region "---------------------------------------------- GetFiles Media --------------------------------------------------------"
    ...
    Public Shared Function GetFilesExtension(path As String,
                                         filter As List(Of String),
                                         Optional searchOption As IO.SearchOption = IO.SearchOption.AllDirectories) As List(Of String)
        ...
        Dim temp As List(Of String) = GetFiles(path, "*", searchOption) _
                    .Where(Function(f) filter.Contains(IO.Path.GetExtension(f).ToLower())).ToList
    ...
    Public Shared Function GetFilesVideo(path As String, Optional searchOption As IO.SearchOption = IO.SearchOption.AllDirectories) As List(Of String)

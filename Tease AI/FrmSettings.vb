...
Public Class FrmSettings
	...
	Public Sub FrmSettingStartUp()
		...
		Debug.Print("Dom personality = " & MainWindow.dompersonalitycombobox.Text)
		Debug.Print("WEB THING HELLO???" & Application.StartupPath & "\Scripts\" & MainWindow.dompersonalitycombobox.Text & "\Playlist\Start\")
...
SkipDeserializing:
    ...
    Public Sub LoadStartScripts() Handles StartScripts.GotFocus
        Try
